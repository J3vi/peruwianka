...
Estos Términos y Condiciones ("Términos") regulan el acceso y uso del sitio web Peruwianka (el "Sitio"),
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>[RAZÓN SOCIAL / NOMBRE LEGAL]</strong></li>
        ...
        <p className="mt-4 text-sm text-gray-600">
          Si estos datos están pendientes de formalización, se indicará como [PENDIENTE] y se actualizarán cuando corresponda.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong>"Producto":</strong> artículos ofrecidos en el Sitio.</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <li>Los precios se muestran en [PLN] e incluyen impuestos aplicables, salvo indicación expresa.</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Para ejercerlo, debes comunicarlo por escrito a [EMAIL] indicando: número de pedido, nombre y datos de contacto.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Productos desprecintados que no sean aptos para devolución por razones de higiene o protección de la salud.
          </li>
        </ul>
        <p className="mt-4 text-sm text-gray-600">
      ...
      <section className="mb-8">
        ...
        <p>
          Se procesarán tras recibir e inspeccionar la devolución, o tras verificar el incidente (daño/error).
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>Asunto sugerido: "Reclamación – Pedido #____"</p>
        <p className="mt-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          El tratamiento de datos personales se rige por nuestra Política de Privacidad disponible en /politica-de-privacidad.
        </p>
      </section>
